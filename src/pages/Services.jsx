...
const cats = [
  {
    ...
    icon_color: 'bg-[#003D73]/10 text-[#003D73] dark:bg-blue-900/40 dark:text-blue-300',
    items: [
  ...
  },
  {
    ...
    icon_color: 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300',
    items: [
  ...
  },
  {
    ...
    icon_color: 'bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300',
    items: [
  ...
  },
  {
    ...
    icon_color: 'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300',
    items: [
...
export default function Services() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Stadtservices Aachen</h1>
        <p className="text-gray-500 dark:text-gray-400">Alle wichtigen Behörden und Einrichtungen im Überblick</p>
      </div>
        ...
        {cats.map(cat => (
          <div key={cat.title}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {cat.items.map(item => (
                <div key={item.name} className={`${cat.color} rounded-2xl p-5 cursor-pointer hover:shadow-md transition-shadow border border-transparent hover:border-gray-200 dark:hover:border-gray-600`}>
